...
//             earthCloud.updateMatrix()
//             containerEarth.add(earth);
//             containerEarth.add(earthCloud);
//             containerEarth.updateMatrix();
...
//                 particle.name= `portalParticle${p}`
...
//     const deleteParticles = (scene) => {
//         let tl = new TimelineMax();

//         let particlePromises = [];
//         let smokePromises = [];
        
//         dimLight(portalLight)
//         dimLight(sceneLight)
...
//         // for (let p in portalParticles) {
//         //     particlePromises.push(new Promise(function(resolve, reject) {
//         //         resolve(tl.to(portalParticles[p].material, 4, {opacity: 0, ease: Power4.easeOut}))
//         //     }))
//         // }
        
//         // for (let s in smokeParticles) {
//         //     smokePromises.push(new Promise(function(resolve, reject) {
//         //         resolve(tl.to(smokeParticles[s].material, 4, {opacity: 0, ease: Power4.easeOut}))
//         //     }))        
//         // }

//         Promise.all([...particlePromises, ...smokePromises]).then(function(values) {
//             // for (let p in portalParticles) {
//             //     // removeObject(portalParticles[p])
//             //     scene.remove(portalParticles[p])
//             //     // particlePromises.push(new Promise(function(resolve, reject) {
//             //         // resolve(tl.to(portalParticles[p].material, 10, {opacity: 0, ease: Power4.easeOut}))
//             //     // }))
//             // }
            
//             // for (let s in smokeParticles) {
//             //     // removeObject(smokeParticles[s])
//             //     scene.remove(smokeParticles[s])
//             //     // smokePromises.push(new Promise(function(resolve, reject) {
//             //     //     resolve(tl.to(smokeParticles[s].material, 10, {opacity: 0, ease: Power4.easeOut}))
//             //     // }))        
//             // }
...
//         // Promise.all([...particlePromises, ...smokeParticles]).then(function(values) {
//         //     for (let p in portalParticles) {
//         //         // removeObject(portalParticles[p])
//         //         scene.remove(portalParticles[p])
//         //         // particlePromises.push(new Promise(function(resolve, reject) {
...
//         //     // Create a new directional light
//         //     var light = new THREE.DirectionalLight( 0xfff1ef, 1 )
//         //     light.position.set(20,10,20)
//         //     scene.add( light )
...
//     const dimLight = (object) => {
//         var selectedObject = scene.getObjectByName(object.name);
//         let tl = new TimelineMax()
//         tl.to(selectedObject, 4, {intensity: 0, ease: Power4.easeOut, onComplete: removeObject(object)})
//         animate();
//     }

//     let loadModels = () => {
//         portalParticles = undefined
//         smokeParticles = undefined
//         portalLight = undefined
//         sceneLight = undefined
//         console.log(portalParticles)
//         console.log(smokeParticles)
//         console.log(portalLight)
...
//             // if (models.includes("tiny_planet")) {
//             //     tinyPlanet = loadTinyPlanet(scene, manager, tinyPlanet)
//             // }
...
function App() {
    ...
    let loadModels = () => {
        ...
        if (dimensionData.models) {
            ...
            if (models.includes("cromulon")) {
                cromulon = loadCromulon(scene, manager, tinyPlanet)
                toLoad.push(cromulon)
            }

            if (models.includes("tiny_planet")) {
                tinyPlanet = loadTinyPlanet(scene, manager, tinyPlanet)
                toLoad.push(tinyPlanet)
            }
    ...
    return (
        <div>
            ...
            <button className="warp" onClick={e => init()}>WARP</button>
            <h1 id="title">Ricktastic Planetarium</h1>
            <section id="player-container">
                <div id="player" className="centered">
                    {playing && 
